...
public interface Merge<P, R> {
    ...
    default Optional<R> resultFromProperties(P p1, P p2) {
        for(OverallMergeProperty<P, R> property : generateOverallProperties(p1, p2)) {
     ...
     */
    List<? extends OverallMergeProperty<P, R>> generateOverallProperties(P p1, P p2);
}
