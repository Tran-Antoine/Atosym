...
import net.akami.mask.check.ValidityCheck;
...
public class Mask {
     ...
     * @param context the MaskContext the mask belongs to
     */
    ...
    /**
     * @return the mathematical expression that the mask handles
     */
    ...
    /**
     * Reloads the mask with the given expression. If {@code null}, the new expression will be "undefined". <br>
